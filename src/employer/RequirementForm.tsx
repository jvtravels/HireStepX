...
/* Shared by the "post a new requirement" and "edit a requirement" pages —
   identical fields, only the eyebrow copy, submit-button label, and
   onSubmit behavior differ. */
            ...
            <>
              ...
              <div style={{ display: "flex", gap: 12 }}>
                ...
                <PrimaryCta type="submit" full disabled={submitting}>
                  {submitting ? (mode === "create" ? "Posting job…" : "Saving…") : (mode === "create" ? "Post Job" : "Save changes")}
                </PrimaryCta>
              </div>
            </>
          )}
