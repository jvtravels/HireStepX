...
function PaginationLink({
  ...
  return (
    ...
    >
      {/* eslint-disable-next-line jsx-a11y/anchor-has-content -- content always arrives via the spread `props.children` from callers (e.g. PaginationPrevious/Next), invisible to static analysis here */}
      <a
