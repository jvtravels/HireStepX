    ...
    <div style={{ minHeight: "100vh", background: T.cream, display: "flex", flexDirection: "column", color: T.coal, fontFamily: F.sans }}>
      ...
      <style>{`
        ...
        /* Small desktop (≤1280px, e.g. 13" laptops at 1280×800) — compress
           the hero + spacing so the form fits without scrolling. */
        @media (max-width: 1280px) {
          .hsx-setup-topbar { padding: 16px 32px !important; }
          .hsx-setup-content { padding: 20px 32px 56px !important; }
          .hsx-setup-hero-h1 { font-size: clamp(1.75rem, 4vw, 2.75rem) !important; }
          .hsx-setup-hero { margin-bottom: 20px !important; }
          .hsx-setup-hero-sub { margin-top: 10px !important; font-size: 15px !important; }
          .hsx-setup-hero-pillrow { margin-top: 10px !important; gap: 6px !important; }
          .hsx-setup-form-sections { gap: 20px !important; }
          .hsx-setup-cta-zone { margin-top: 24px !important; padding-top: 16px !important; }
        }
