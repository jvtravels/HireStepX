...
const DICT: Record<string, FriendlyFlag> = {
  ...
  ai_accepted_vague: { label: "AI accepted a vague 'we / team' answer", description: "User answered in collective framing without naming personal contribution; AI rolled forward instead of probing for ownership.", category: "ai_didnt_push_back" },
  ai_accepted_unevidenced_metric: { label: "AI accepted naked numbers without probing", description: "User cited a metric without baseline / method / sample; AI didn't ask 'what was the baseline?' or 'how was that measured?'.", category: "ai_didnt_push_back" },
  ...
  attrition_risk_higher_studies: { label: "User signaled higher-studies plan (attrition risk)", description: "User stated MBA / MS / GRE / CAT plan within 1-2 years. At service-tier (TCS/Infosys/Wipro) this is an immediate red flag — bonds recover training cost over 2 years.", category: "user_skipped_step" },
  relocation_refusal: { label: "User refused relocation outright", description: "User flatly refused to relocate. Dealbreaker at TCS/Infosys/Wipro/Cognizant where allocation is pan-India. Frame constraints as questions about allocation, not refusals.", category: "user_skipped_step" },
  shift_oncall_refusal: { label: "User refused night-shift / on-call outright", description: "User refused rotational / US-shift / on-call. Common dealbreaker; ask about cadence before refusing.", category: "user_skipped_step" },
  cliche_strength_weakness: { label: "User gave a cliché strength / weakness", description: "User said 'I'm a perfectionist' / 'I work too hard' / 'workaholic'. Interviewers hear these 5+ times daily — pick a real, calibrated weakness instead.", category: "user_skipped_step" },
  tmay_resume_recital: { label: "User read off the resume in 'tell me about yourself'", description: "User said 'as per my resume' / 'as you can see in my resume' — signals reading off the page. TMAY is a structure question, not a recital.", category: "user_skipped_step" },
  career_goal_vague: { label: "User gave a vague 5-year career goal", description: "AI asked the 5-year question — user replied with 'successful' / 'in a senior position' / 'wherever life takes me'. Specific roles (SDE-2, tech lead, product specialist) score; vague answers don't.", category: "user_skipped_step" },
  hackathon_unsubstantiated: { label: "Hackathon mentioned without detail", description: "User cited a hackathon / coding contest but gave no theme, team size, duration, rank, or what was built. Resume-padding signal.", category: "user_skipped_step" },
  buzzword_soup: { label: "User listed 5+ trendy areas with no anchor project", description: "User listed AI / ML / blockchain / IoT / cloud / web3 etc. as interests with no concrete project or tech stack to back any of them. Reads as buzzword resume.", category: "user_skipped_step" },
  family_pressure_framing: { label: "User framed career as parent-driven", description: "User said 'my parents wanted me to do engineering' / 'because of my family'. Signals lack of ownership — own the choice even if it originated from family.", category: "user_skipped_step" },
  negative_company_compare: { label: "User disparaged another company", description: "User compared the target unfavourably to another firm (or trashed a competitor). Reads as immature; recruiters note 'will say negative things about us in 2 years.'", category: "user_skipped_step" },
  salary_expectation_inflated: { label: "Inflated salary expectation for tier", description: "User quoted an LPA number well above fresher campus band for the company tier (service ~₹4.5L, Indian product ~₹15L, global product India ~₹30L). Signals no market research.", category: "user_skipped_step" },
  salary_raised_too_early: { label: "User asked about salary in the technical round", description: "User raised CTC / salary in the first few turns before AI did. Wrong round = wrong priorities signal. Wait for HR / final round, or for the interviewer to bring it up.", category: "user_skipped_step" },
  portfolio_absent_for_claim: { label: "Built-claim with no public artifact", description: "User claimed to have built / shipped a project but never referenced GitHub, a live demo, or any public link. Adds 10x credibility when present; absence is a soft signal.", category: "user_skipped_step" },
  ...
  we_attribution_heavy: { label: "User narrated the team's work, not their own", description: "Most answers leaned on 'we / the team' framing without a first-person action verb — interviewer can't tell what the candidate personally did.", category: "user_skipped_step" },
  answer_off_topic: { label: "User drifted from the question's intent", description: "Multiple answers didn't address what the AI actually asked — pattern of paraphrasing to a different theme.", category: "user_skipped_step" },
  rambling_answers: { label: "Long answers without a measurable outcome", description: "Two or more answers ran past 1800 characters with no Result + no quantification — candidate filling space instead of landing impact.", category: "user_skipped_step" },
  rehearsed_answers: { label: "Answers opened with memorised stock phrases", description: "Multiple answers led with 'let me tell you about a time…' / 'to answer your question…' — reads as scripted rather than situational.", category: "user_skipped_step" },
  low_conviction_delivery: { label: "Hedge-heavy delivery across multiple answers", description: "Stacks of um / like / I think / maybe / kind of — interviewers read hedge density as uncertainty about the substance.", category: "user_skipped_step" },
  one_sided_conflict_narrative: { label: "Conflict answers ran one-sided", description: "Multiple conflict / disagreement answers walked through what the candidate did without naming what the other side wanted or believed.", category: "user_skipped_step" },
  metric_without_baseline: { label: "Numbers quoted without a baseline or method", description: "Candidate cited '+30%' / '5x faster' without saying from what, how it was measured, or the sample — invites the next probe at senior level.", category: "user_skipped_step" },
  no_learning_reflection: { label: "No 'what I'd do differently' across the session", description: "Longer behavioral session with zero learning-mode reflection ('in hindsight…', 'next time I would…') — lands flat in Indian behavioral rounds.", category: "user_skipped_step" },
  deflects_failure: { label: "Failure question routed to external blame", description: "Candidate answered the failure question by pointing at team / management / scope instead of owning a personal miss.", category: "user_skipped_step" },
  weak_specificity_in_failure_story: { label: "Failure ownership without a specific miss", description: "Candidate took accountability ('my mistake', 'I underestimated it') but never named WHAT specifically they missed — a system, an assumption, a stakeholder, a risk. Senior interviewers expect the concrete miss-token in the same sentence as the ownership.", category: "user_skipped_step" },
