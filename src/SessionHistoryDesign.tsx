...
/* Theme palettes live in ./sessionHistoryThemes (a .ts module) so the raw
   hex literals stay out of .tsx scope (design-token gate). `theme` prop
   selects "editorial" (canvas-only register) or "hirestepx" (production
   cream-mode brand). */
