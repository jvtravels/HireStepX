...
> = {
  ...
  flipkart: {
    ...
    "ux-designer": {
      ...
      senior: { totalMin: 22.0, totalMax: 58.0, baseMin: 17.2, baseMax: 45.2, equityMin: 2.6, equityMax: 7.0, equityType: "esop", equityVesting: "4yr / 1yr cliff", source: "Curated research 2026-05-09 — 6figr (Flipkart Sr Product Designer / PD II-III, 4-8y avg ₹28-35L, top ₹40-60L)", lastVerified: "2026-05-09", notes: "Flipkart Senior UX/Product Designer. Avg CTC ₹28-46L, top earners ₹40-60L (4-8y). Bonus ₹2-7L. Joining bonus ₹2-8L. 90-day notice. Negotiation focus: ownership + craft + level mapping (PD II vs III)." },
