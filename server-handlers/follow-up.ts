...
Repeat-text in followUpText is FORBIDDEN.`;
    ...
    if (isSalaryNeg && parsed.followUpText) {
      ...
      const didWalkAway = (() => {
        ...
        return walkRe.test(postHedge) && !walkAwayNegationCoversLocal(postHedge);
      })();
