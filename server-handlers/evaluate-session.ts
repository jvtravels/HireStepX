  ...
  "perQuestion": [
    {
      ...
      "topPerformerAnswer": {
        "text": "<a synthesized 90/100 answer to THIS question, calibrated to the target role and company. You MAY invent realistic company names, metrics, and outcomes here — the purpose is to show what excellence looks like. STRICT length: 80-130 words MAX. Real interview answers are conversational, not press releases. Use STAR structure with concrete quantification. Open with the situation in one tight sentence; spend most of the answer on the Action; close with the Result. NEVER open with 'My background in X has given me…' or 'I'm particularly drawn to…' — those are LLM-resume openers, not how candidates actually speak.>",
