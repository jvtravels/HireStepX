...
const NEGATABLE_DEPARTURE =
  /\b(?:walk(?:ing|in)?(?:\s+away|\s+out)?|pull(?:ing)? out|back(?:ing)? out|withdraw(?:ing)?|drop(?:ping)? out|declin(?:e|ing))\b/gi;
