...
/* Twitter / X card image — mirrors the OG image at the same 1200×630 dimensions.
 * Next.js auto-wires this file as the twitter:image meta tag for the root route. */
