/* Shared source of truth for /methodology's JSON-LD, used by both the page
...
const BREADCRUMB_SCHEMA = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Methodology", item: "https://hirestepx.com/methodology" },
  ],
};

export function buildMethodologyJsonLd(): { __html: string }[] {
