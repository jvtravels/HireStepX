...
/* Metadata image routes under a dynamic segment don't inherit the sibling
   ...
   slugs for this route and 404s even though /companies/[slug] itself is a
...
export default async function OpengraphImage({
  ...
  const headline = page ? page.searchPhrase : "Interview Preparation";
    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
          ...
          >
            Practice with AI voice feedback. Get scored on every answer.
          </div>
        </div>
