...
/* Shared source of truth for /grievance's JSON-LD, used by both the page
...
export function buildGrievanceJsonLd(): { __html: string }[] {
  return [ldJson(breadcrumb([{ name: "Grievance Officer", path: "/grievance" }]))];
}
