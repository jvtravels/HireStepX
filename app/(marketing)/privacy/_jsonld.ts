...
/* Shared source of truth for /privacy's JSON-LD, used by both the page
...
export function buildPrivacyJsonLd(): { __html: string }[] {
  return [ldJson(breadcrumb([{ name: "Privacy", path: "/privacy" }]))];
}
