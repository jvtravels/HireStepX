...
/* Shared source of truth for /referral's JSON-LD, used by both the page
...
export function buildReferralJsonLd(): { __html: string }[] {
  return [ldJson(breadcrumb([{ name: "Refer a friend", path: "/referral" }]))];
}
